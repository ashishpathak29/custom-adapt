define(function(require) {
    ...
    var Narrative = ComponentView.extend({
        ...
        events: {
			...
			'click .notifyPopup .closebtn':'popupClose',
			'click .narrative-slider-graphic img': 'onImageClicked'
        },
		...
		onImageClicked: function(event)
		{
			...
			//var _src = currentItem._graphic.src;
			//$('.notifyPopup .innerContent').html("<div class='big_img'><img src='"+_src.toString()+"' alt='' /></div>");
		},
        ...
        openPopup: function(event) {
            ...
            var currentItem = this.getCurrentItem(this.model.get('_stage'));
			$('.notifyPopup .innerContent').html(currentItem.body);
            var popupObject = {
    ...
    Adapt.register('customNarrative', Narrative);
